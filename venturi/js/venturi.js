...
var count=0;
var time=0;
var gx1=0,gx2=0,gx3=0,gx4=0;
var gy1=0,gy2=0,gy3=0,gy4=0;
var dia=0,k1=0,k2=0,k3=0;k4=0;
var graph;
...
function goToNextFunction()
{
	...
	else if(simsubscreennum == 6 && resultCount == 0)
	{
		...
		qCount = 0;
		switch(dia) {
			case "50mm": qthVal = mano50[6][p];
						break;
			case "40mm": qthVal = mano40[6][p];
						break;
			case "20mm": qthVal = mano20[6][p];
		}
	...
	else if(simsubscreennum == 6 && resultCount == 1)
	{
		...
		qCount = 0;
		switch(dia) {
			case "50mm": cdVal = mano50[7][p];
						break;
			case "40mm": cdVal = mano40[7][p];
						break;
			case "20mm": cdVal = mano20[7][p];
						break;
		}
...
function magic()
{
	...
	else if (simsubscreennum==2)
	{
		...
		if(repeat<=8 && repeat>1)
	 {
		...
		document.getElementById('arr').style="visibility:visible ;position:absolute; left: 340px; top: 450px; height: 30px; z-index: 10;";
		...
		document.getElementById('pvalve').onclick=function(){step2();}	 
    }
	...
	else if (simsubscreennum==3)
	{
		...
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 575px; top: 170.75px;   height: 30px; z-index: 10;";
		...
		document.getElementById('b5').onclick=function(){step3a();}	 
	...
	if(repeat<=4 && repeat>=1)
	 {
		...
		if(dia=="50mm")
		{
		document.getElementById('flow').style="position:absolute;left:10px;top:348.5px;visibility:visible;";
		}
		else if(dia=="40mm")
		{
	...
	else if (simsubscreennum==5)
	{
					if(repeat<=4 && repeat>=1)
	 {
		...
		document.getElementById("arr").style.msTransform = "rotate(35deg)"; 
				 // Standard syntax
		document.getElementById("arr").style.transform = "rotate(35deg)";
		document.getElementById('circle5').onclick=function(){step5a();}	 
	...
	else if (simsubscreennum==6)
	{
        ...
        if(dia=="50mm")
		{
			...
			document.getElementById('70').innerHTML="Area A<sub>1</sub>=19.625cm<sup>2</sup> ";
			document.getElementById('70a').innerHTML="Area A<sub>2</sub>=5.81cm<sup>2</sup>";
			document.getElementById('72').innerHTML="Time taken (t)="+mano50[4][p]+"sec";
			document.getElementById('73').innerHTML="Head Loss (H)="+(12.6*(mano50[0][p]-mano50[1][p])).toFixed(2)+"cm";
			qactVal = mano50[5][p];
        ...
        else if(dia=="40mm")
		{
			...
			document.getElementById('70').innerHTML="Area A<sub>1</sub>=12.568cm<sup>2</sup> ";
			document.getElementById('70a').innerHTML="Area A<sub>2</sub>=4.397cm<sup>2</sup>";
			document.getElementById('72').innerHTML="Time taken (t)="+mano40[4][p]+"sec";
			document.getElementById('73').innerHTML="Head Loss (H)="+(12.6*(mano40[0][p]-mano40[1][p])).toFixed(2)+"cm";
			qactVal = mano40[5][p];
			document.getElementById('74').innerHTML="Q<sub>act</sub> = ";
			idInput = document.getElementById('74');
			userCalculation(idInput);
	    ...
	    else if(dia=="20mm")
		{
			...
			document.getElementById('70').innerHTML="Area A<sub>1</sub>=4cm<sup>2</sup> ";
			document.getElementById('70a').innerHTML="Area A<sub>2</sub>=1.8496cm<sup>2</sup>";
			document.getElementById('72').innerHTML="Time taken (t)="+mano40[4][p]+"sec";
			document.getElementById('73').innerHTML="Head Loss (H)="+(12.6*(mano20[0][p]-mano20[1][p])).toFixed(2)+"cm";
			qactVal = mano20[5][p];
			document.getElementById('74').innerHTML="Q<sub>act</sub> = ";
			idInput = document.getElementById('74');
			userCalculation(idInput);
	...
	{	
      ...
      document.getElementById('70b').style.visibility="hidden";
		...
		graph=[[gx1,gy1],
				 ...
				 [gx3,gy3],
				 [gx4,gy4]];
		graph.sort(function(x,y){return x[0]-y[0]});
		if(dia=="50mm")
		{
		document.getElementById('step7text1').onclick=function(){step750();}
		}
		else if(dia=="40mm")
		{
		document.getElementById('step7text1').onclick=function(){step740();}
		}
		else if(dia=="20mm")
		{
		document.getElementById('step7text1').onclick=function(){step720();}
		}
	...
	function step21()
	{
		...
		if(dia == "50mm")
		{
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 190px; top: 200px;   height: 20px; z-index: 10;";
		document.getElementById("arr").style.WebkitTransform = "rotate(90deg)"; 
				 // Code for IE9
		document.getElementById("arr").style.msTransform = "rotate(90deg)"; 
				 // Standard syntax
		...
		document.getElementById("circle2").style="position:absolute;cursor:zoom-in;visibility:visible;left: 132px; top: 178px;";
		document.getElementById('circle2').onclick=function(){step22();}
		...
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 190px; top: 264px;   height: 20px; z-index: 10;";
		document.getElementById("arr").style.WebkitTransform = "rotate(90deg)"; 
				 // Code for IE9
		document.getElementById("arr").style.msTransform = "rotate(90deg)"; 
				 // Standard syntax
		...
		document.getElementById("circle2").style="position:absolute;visibility:visible;cursor:zoom-in; left: 132px; top: 236px;";
		document.getElementById('circle2').onclick=function(){step22();}
		...
		{
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 190px; top: 315px;   height: 20px; z-index: 10;";
		document.getElementById("arr").style.WebkitTransform = "rotate(90deg)"; 
				 // Code for IE9
		document.getElementById("arr").style.msTransform = "rotate(90deg)"; 
				 // Standard syntax
		...
		document.getElementById("circle2").style="position:absolute;visibility:visible;cursor:zoom-in; left: 132px; top: 288.5px;";
		document.getElementById('circle2').onclick=function(){step22();}
		}
	...
	function step22()
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		 document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 225px; top: 180.75px;  height: 30px; z-index: 10;";
		 document.getElementById("arr").style.WebkitTransform = "rotate(35deg)"; 
				 // Code for IE9
		 document.getElementById("arr").style.msTransform = "rotate(35deg)"; 
				 // Standard syntax
		 ...
		 if(dia=="50mm")
		 {
		  document.getElementById('meter1').onclick=function(){step2b();}	 	
		 }
		else	 
		 document.getElementById('meter').onclick=function(){step2b();}	 	
	}
	...
	function step2b()
	{
        ...
        myInt = setInterval(function(){ animatearrow(); }, 500);
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 590px; top: 180.75px;  height: 30px; z-index: 10;";
		document.getElementById("arr").style.WebkitTransform = "rotate(35deg)"; 
				 // Code for IE9
		document.getElementById("arr").style.msTransform = "rotate(35deg)"; 
				 // Standard syntax
		document.getElementById("arr").style.transform = "rotate(35deg)";
		document.getElementById('b1').onclick=function(){step2c();}	 
	...
	function step2c()
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 652px; top: 180.75px;  height: 30px; z-index: 10;";
		...
		document.getElementById('b2').onclick=function(){step2d();}	 
	}
	...
	function step3a()
	{
		...
		myInt = setInterval(function(){ animatearrow(); }, 500);
		document.getElementById('arr').style="visibility:visible ;position:absolute;  left: 668px; top: 165.75px;  height: 30px; z-index: 10;";
		document.getElementById("arr").style.WebkitTransform = "rotate(-215deg)"; 
				 // Code for IE9
		document.getElementById("arr").style.msTransform = "rotate(-215deg)"; 
				 // Standard syntax
		document.getElementById("arr").style.transform = "rotate(-215deg)";
		document.getElementById('b6').onclick=function(){step3b();}	 
	}
	...
	function step3e()
	{
		...
		setTimeout(function()
		{
		 if(dia=="50mm")
			{
			document.getElementById('lw').innerHTML="Left Limb Reading (LL)&nbsp=&nbsp"+mano50[0][p]+"cm";
			document.getElementById('rw').innerHTML="Right Limb Reading (RL)&nbsp=&nbsp"+mano50[1][p]+"cm";
			...
			{
			document.getElementById('lw').innerHTML="Left Limb Reading (LL)&nbsp=&nbsp"+mano40[0][p]+"cm";
			document.getElementById('rw').innerHTML="Right Limb Reading (RL)&nbsp=&nbsp"+mano40[1][p]+"cm";
			...
			{
			document.getElementById('lw').innerHTML="Left Limb Reading (LL)L&nbsp=&nbsp"+mano20[0][p]+"cm";
			document.getElementById('rw').innerHTML="Right Limb Reading (RL)&nbsp=&nbsp"+mano20[1][p]+"cm";
	...
	function step5a()
	{
		...
		document.getElementById('time').innerHTML="Time required by water to fill 5cm height&nbsp=&nbsp"+mano50[4][p]+"s";
		}
		else if(dia=="40mm")
		{
		document.getElementById('time').style.visibility="visible";
		document.getElementById('time').innerHTML="Time required by water to fill 5cm height&nbsp=&nbsp"+mano40[4][p]+"s";
		}
		else if(dia=="20mm")
		{
		document.getElementById('time').style.visibility="visible";
		document.getElementById('time').innerHTML="Time required by water to fill 5cm height&nbsp=&nbsp"+mano20[4][p]+"s";
		}	
        document.getElementById('nextButton').style.visibility="visible";		
		},1500);
